            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
              {selectedEvent ? (
                <div className="bg-white border border-gray-100 rounded-3xl shadow-sm p-6 flex flex-col gap-4">
                  ...
                  <a href="https://www.eventbrite.ca/e/1986940258801?aff=oddtdtcreator" target="_blank" rel="noopener noreferrer" className="mt-2 w-full py-3 rounded-2xl bg-[#1a1a2e] text-white text-sm font-bold text-center hover:bg-[#0f3460] transition-colors flex items-center justify-center gap-2">
