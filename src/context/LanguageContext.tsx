...
const translations = {
  fr: {
    ...
    services: {
      ...
      cta: "En savoir plus →",
      items: [
        { icon: "🇫🇷", color: "#003087", title: "Cours de français", description: "Apprentissage du français pour adultes et enfants, tous niveaux confondus, dans un cadre bienveillant.", link: "/cours-de-francais", cta: "Accéder aux leçons →" },
        { icon: "🤝", color: "#006B3C", title: "Intégration sociale", description: "Accompagnement personnalisé pour faciliter l'installation et l'intégration dans la société québécoise.", link: null, cta: null },
        { icon: "⚽", color: "#F4A300", title: "Intégration par le sport", description: "Programmes sportifs pour jeunes de 12 à 30 ans favorisant l'inclusion et le dépassement de soi.", link: null, cta: null },
        { icon: "👨‍👩‍👧", color: "#C8102E", title: "Soutien aux familles", description: "Ressources et ateliers pour les familles nouvellement arrivées, guidance parentale et soutien scolaire.", link: null, cta: null },
        { icon: "💼", color: "#7C3AED", title: "Aide à l'emploi", description: "Accompagnement dans la recherche d'emploi, rédaction de CV et préparation aux entrevues. 📌 Offres d'emploi bientôt disponibles !", link: "/aide-emploi", cta: "Accéder aux outils →" },
        { icon: "🌍", color: "#0891B2", title: "Échanges culturels", description: "Événements et activités pour célébrer la diversité culturelle et tisser des liens entre communautés.", link: null, cta: null },
        { icon: "🎶", color: "#E11D78", title: "Danse, musique & festivals", description: "Soirées et festivals multiculturels pour célébrer les arts, la musique et les traditions du monde entier.", link: null, cta: null },
      ],
    },
    activities: {
  ...
  en: {
    ...
    services: {
      ...
      cta: "Learn more →",
      items: [
        { icon: "🇫🇷", color: "#003087", title: "French classes", description: "French language learning for adults and children at all levels, in a welcoming environment.", link: "/cours-de-francais", cta: "Go to lessons →" },
        { icon: "🤝", color: "#006B3C", title: "Social integration", description: "Personalized support to ease settlement and integration into Quebec society.", link: null, cta: null },
        { icon: "⚽", color: "#F4A300", title: "Sport integration", description: "Sports programs for youth aged 12 to 30 promoting inclusion and personal growth.", link: null, cta: null },
        { icon: "👨‍👩‍👧", color: "#C8102E", title: "Family support", description: "Resources and workshops for newly arrived families, parental guidance and academic support.", link: null, cta: null },
        { icon: "💼", color: "#7C3AED", title: "Employment help", description: "Support for job searching, resume writing and interview preparation. 📌 Job listings coming soon!", link: "/aide-emploi", cta: "Access the tools →" },
        { icon: "🌍", color: "#0891B2", title: "Cultural exchanges", description: "Events and activities to celebrate cultural diversity and build bridges between communities.", link: null, cta: null },
        { icon: "🎶", color: "#E11D78", title: "Dance, music & festivals", description: "Multicultural evenings and festivals celebrating arts, music and traditions from around the world.", link: null, cta: null },
      ],
    },
    activities: {
      badge: "Join us",
