...
const translations = {
  fr: {
    ...
    services: {
      ...
      items: [
        { icon: "🇫🇷", title: "Cours de français", desc: "Apprentissage du français pour adultes et enfants, tous niveaux." },
        { icon: "🤝", title: "Intégration sociale", desc: "Accompagnement personnalisé pour faciliter l'installation et l'intégration." },
        { icon: "⚽", title: "Intégration par le sport", desc: "Programmes sportifs pour jeunes de 12 à 30 ans favorisant l'inclusion." },
        { icon: "👨‍👩‍👧", title: "Soutien aux familles", desc: "Ressources et ateliers pour les familles nouvellement arrivées." },
        { icon: "💼", title: "Aide à l'emploi", desc: "Accompagnement dans la recherche d'emploi et rédaction de CV." },
        { icon: "🌍", title: "Échanges culturels", desc: "Événements et activités pour célébrer la diversité culturelle." },
      ],
    },
    activities: {
    ...
    about: {
      ...
      caMembers: [
        { nom: "Ronisia Jolagreen", role: "Présidente" },
        { nom: "Jean-Pierre Moïse", role: "Vice-président" },
        { nom: "Fatima Zahra El Amrani", role: "Secrétaire" },
      ],
  ...
  en: {
    ...
    services: {
      ...
      items: [
        { icon: "🇫🇷", title: "French classes", desc: "French language learning for adults and children, all levels." },
        { icon: "🤝", title: "Social integration", desc: "Personalized support to ease settlement and integration." },
        { icon: "⚽", title: "Sport integration", desc: "Sports programs for youth aged 12 to 30 promoting inclusion." },
        { icon: "👨‍👩‍👧", title: "Family support", desc: "Resources and workshops for newly arrived families." },
        { icon: "💼", title: "Employment help", desc: "Support for job searching and resume writing." },
        { icon: "🌍", title: "Cultural exchanges", desc: "Events and activities to celebrate cultural diversity." },
      ],
    },
    activities: {
      badge: "Join us",
    ...
    about: {
      ...
      caMembers: [
        { nom: "Ronisia Jolagreen", role: "President" },
        { nom: "Jean-Pierre Moïse", role: "Vice-president" },
        { nom: "Fatima Zahra El Amrani", role: "Secretary" },
      ],
