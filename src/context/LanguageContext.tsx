  ...
  fr: {
    ...
    services: {
      ...
      items: [
        ...
        { icon: "💼", color: "#7C3AED", title: "Aide à l'emploi", description: "Accompagnement dans la recherche d'emploi, rédaction de CV et préparation aux entrevues. 📌 Offres d'emploi bientôt disponibles !", link: null, cta: null },
  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        { icon: "💼", color: "#7C3AED", title: "Employment help", description: "Support for job searching, resume writing and interview preparation. 📌 Job listings coming soon!", link: null, cta: null },
